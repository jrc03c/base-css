  ...
  function finishComponentSetup(instance, isSSR, skipOptions) {
    ...
    if (!instance.render) {
      if (!isSSR && compile && !Component.render) {
        const template19 = Component.template || __VUE_OPTIONS_API__ && resolveMergedOptions(instance).template;
        if (template19) {
          if (true) {
          ...
          Component.render = compile(template19, finalCompilerOptions);
          if (true) {
  ...
  var nodeOps = {
    ...
    insertStaticContent(content, parent, anchor, namespace, start, end) {
      ...
      if (start && (start === end || start.nextSibling)) {
        ...
        const template19 = templateContainer.content;
        if (namespace === "svg" || namespace === "mathml") {
          const wrapper = template19.firstChild;
          while (wrapper.firstChild) {
            template19.appendChild(wrapper.firstChild);
          }
          template19.removeChild(wrapper);
        }
        parent.insertBefore(template19, anchor);
      }
      return [
        // first
...
`,
  ...
  function compileToFunction(template19, options) {
    if (!isString(template19)) {
      if (template19.nodeType) {
        template19 = template19.innerHTML;
      } else {
        warn2(`invalid template option: `, template19);
        return NOOP;
      }
    }
    const key = genCacheKey(template19, options);
    const cached = compileCache[key];
    if (cached) {
      return cached;
    }
    if (template19[0] === "#") {
      const el = document.querySelector(template19);
      if (!el) {
        warn2(`Template element not found or is empty: ${template19}`);
      }
      template19 = el ? el.innerHTML : ``;
    }
    const opts = extend(
      {
        hoistStatic: true,
    ...
    const { code } = compile2(template19, opts);
...
`
  ...
  var BannerView = createVueComponentWithCSS({
    name: "x-banner-view",
    template,
    data() {
      return {
...
`
  ...
  var BlockquoteView = createVueComponentWithCSS({
    name: "x-blockquote-view",
    template: template2,
    data() {
      return {
        css: css2
...
`
  ...
  var CodeView = createVueComponentWithCSS({
    name: "x-code-view",
    template: template4,
    data() {
      return {
  ...
  // demo/src/views/columns.mjs
  var css5 = (
    /* css */
    `
  #columns-container .cols .col {
...
`
  ...
  <details>
    ...
    <p>
      ...
      shortbread cotton candy chupa chups cake toffee marzipan jelly lemon
      drops. Sugar plum powder ice cream candy canes cake biscuit pudding
      fruitcake wafer. Chupa chups gingerbread lollipop tart sugar plum gummies
      chocolate cake souffl\xE9 apple pie. Sweet cotton candy apple pie chocolate
      bar brownie sweet roll candy canes donut candy. Danish sugar plum pudding
      jelly-o marzipan. Liquorice tiramisu toffee jujubes apple pie apple pie
      gummies liquorice. Gummi bears danish cake donut chocolate bar tootsie
      roll. Pie liquorice pudding macaroon biscuit. Donut sweet roll liquorice
      bear claw marshmallow halvah. Halvah jelly chocolate bar gingerbread ice
      cream pie croissant tootsie roll carrot cake.
    </p>
...
`
  ...
  var DetailsView = createVueComponentWithCSS({
    name: "x-details-view",
    template: template6,
    data() {
      return {
...
`
  ...
  var FigureView = createVueComponentWithCSS({
    name: "x-figure-view",
    template: template7,
    data() {
      return {
...
`
  ...
  <div class="control">
    <label>A picture of your driver's license</label>
    <input type="file" />
  </div>

  <div class="control">
    <label>Age</label>
    <input type="number" max="150" min="0" placeholder="18" step="1" />
  </div>

  <div class="control">
    <label>Your password</label>
    <input placeholder="p4$$w0rd!" type="password" />
  </div>
  ...
  <div class="control">
    ...
    <div class="radio">
      <input name="meal-preference" type="radio" />
      <label>Chicken</label>
    </div>
  ...
  <div class="control">
    <label>Your level of excitement</label>
  ...
  <div class="control">
    <label>Your dessert preference:</label>
  ...
  <div class="control">
    <label>A long comment</label>
    <textarea placeholder="Dear diary, ..."></textarea>
  </div>
  ...
  <div class="control">
    <label>Dark</label>
    <input class="dark" placeholder="Dark!" type="text" />
  </div>

  <div class="control">
    <label>Danger</label>
    <input class="danger" placeholder="Danger!" type="text" />
  </div>

  <div class="control">
    <label>Warning</label>
    <input class="warning" placeholder="Warning!" type="text" />
  </div>

  <div class="control">
    <label>Success</label>
    <input class="success" placeholder="Success!" type="text" />
  </div>

  <div class="control">
    <label>Primary</label>
    <input class="primary" placeholder="Primary!" type="text" />
  </div>

  <div class="control">
    <label>Info</label>
    <input class="info" placeholder="Info!" type="text" />
  </div>
...
`
  ...
  var FormView = createVueComponentWithCSS({
    name: "x-form-view",
    template: template9,
    data() {
      return {
...
`
  ...
  var HeadingsView = createVueComponentWithCSS({
...
`
  ...
  var HomeView = createVueComponentWithCSS({
    name: "x-home-view",
    template: template11,
    data() {
      return {
  ...
  <p>
    <b>
      <a href="https://saganipsum.com/?p=3">Sagan Ipsum</a>
      :
    </b>
  </p>
  ...
  <ul>
    <li>
      Laws of physics dispassionate extraterrestrial observer quasar billions
      upon billions Cambrian explosion circumnavigated.
    </li>
    <ul>
      <li>
        Concept of the number one at the edge of forever are creatures of the
        cosmos bits of moving fluff a very small stage in a vast cosmic arena
        not a sunrise but a galaxyrise?
      </li>

      <ul>
        <li>
          Inconspicuous motes of rock and gas made in the interiors of
          collapsing stars preserve and cherish that pale blue dot citizens of
          distant epochs permanence of the stars concept of the number one.
        </li>
      </ul>
    </ul>

    <li>
      A billion trillion light years muse about hearts of the stars
      Jean-Fran\xE7ois Champollion culture?
    </li>

    <ul>
      <li>
        With pretty stories for which there's little good evidence are creatures
        of the cosmos rogue are creatures of the cosmos globular star cluster
        invent the universe.
      </li>
      <li>
        Something incredible is waiting to be known Cambrian explosion descended
        from astronomers take root and flourish from which we spring dream of
        the mind's eye.
      </li>
      <li>
        Courage of our questions extraordinary claims require extraordinary
        evidence the carbon in our apple pies a very small stage in a vast
        cosmic arena concept of the number one the sky calls to us?
      </li>
    </ul>

    <li>
      Kindling the energy hidden in matter vastness is bearable only through
      love extraplanetary shores of the cosmic ocean trillion inconspicuous
      motes of rock and gas.
    </li>

    <ul>
      <li>
        Vangelis concept of the number one permanence of the stars astonishment
        bits of moving fluff a mote of dust suspended in a sunbeam?
      </li>
      <ul>
        <li>
          Concept of the number one something incredible is waiting to be known
          venture network of wormholes the only home we've ever known from which
          we spring and billions upon billions upon billions upon billions upon
          billions upon billions upon billions.
        </li>
        <li>
          Star stuff harvesting star light a billion trillion from which we
          spring Orion's sword astonishment circumnavigated. Vangelis concept of
          the number one the ash of stellar alchemy vanquish the impossible
          intelligent beings network of wormholes.
        </li>
        <li>
          Courage of our questions emerged into consciousness extraordinary
          claims require extraordinary evidence the sky calls to us finite but
          unbounded realm of the galaxies.
        </li>
      </ul>
    </ul>
  </ul>
  ...
  <p>
    <b>
      <a href="https://obamaipsum.com/">Obama Ipsum</a>
      :
    </b>
  </p>
  ...
  <ol>
    <li>
      It's the wisdom Moses imparted to those who would succeed him. If you
    ...
    <ol>
      <li>
        We are taking concrete actions to change course. Now, that must be our
        work here on Earth.
      </li>
      <ol>
        <li>
    ...
    <li>
      ...
      other country on earth, is my story even possible. Given my background, my
    ...
    <ol>
      <li>The hope of immigrants setting out for distant shores.</li>
      <li>
      ...
      <ol>
        <li>
          People are coming together around a simple truth - that we are all
          connected, that I am my brother's keeper; I am my sister's keeper.
        </li>
        <li>
      ...
      <li>
        ...
        Israelis this most painful of memories while preventing the peace that
...
`
  ...
  var ListsView = createVueComponentWithCSS({
    name: "x-lists-view",
    template: template12,
    data() {
      return {
...
`
  ...
  <dialog>
    ...
    <div class="box">
      ...
      <p>
        Grandeur self noble suicide law sexuality. Ultimate christianity hope
        play ideal.
      </p>

      <p>
        Moral christianity convictions self selfish faith society overcome hope
        battle play. Hatred moral hatred ideal joy ubermensch salvation moral.
      </p>

      <p>
        Fearful self abstract chaos ocean selfish sexuality philosophy society.
        Snare transvaluation pious suicide free deceptions suicide ideal horror
        war strong ubermensch sexuality. Victorious snare oneself battle gains.
        Eternal-return contradict free hatred salvation.
      </p>

      <p>
        Decrepit god will noble strong virtues convictions will spirit abstract
        love. Convictions ultimate depths horror hope good ocean overcome.
        Ascetic free insofar christianity ultimate. Justice ocean good depths
        horror zarathustra. Good madness eternal-return self spirit christianity
        burying pious. Hope disgust passion society grandeur decieve madness.
        Spirit fearful ultimate love good snare ascetic decieve sexuality
        burying convictions sea value.
      </p>

      <p>
        Abstract battle ascetic marvelous burying hope. Disgust passion overcome
        decieve faith justice of evil dead. Ubermensch horror snare burying
        society horror ideal against. Hatred enlightenment faithful insofar
        inexpedient sexuality deceptions holiest free. Superiority pinnacle
        enlightenment truth joy god gains.
      </p>

      <p>
        Merciful suicide chaos self ascetic passion prejudice. Dead virtues
        madness pinnacle endless overcome derive law dead. Love contradict
        pinnacle hatred endless. Reason law war burying self will joy passion
        reason passion. Decrepit law society decrepit will convictions abstract
        spirit faithful strong horror faith decieve burying. Faithful mountains
        decieve truth battle war abstract ideal insofar.
      </p>

      <p>
        Passion right noble marvelous hope philosophy ultimate philosophy
        ascetic christian fearful hatred oneself. Will pinnacle joy will love
        oneself insofar christian victorious joy pinnacle. Sea horror deceptions
        faithful law. Chaos suicide sexuality madness ideal justice chaos.
        Philosophy battle ultimate battle hatred enlightenment. Ultimate ideal
        society.
      </p>
...
`
  ...
  var ModalView = createVueComponentWithCSS({
    name: "x-modal-view",
    template: template13,
    data() {
      return {
    ...
    <table class="hover">
      ...
      <tbody>
        <tr>
          ...
          <td>theodore.morin@example.com</td>
        </tr>
        <tr>
          <td>Mateo</td>
          <td>Gauthier</td>
          ...
          <td>mateo.gauthier@example.com</td>
        </tr>
        <tr>
          <td>Liam</td>
          <td>Tremblay</td>
          ...
          <td>liam.tremblay@example.com</td>
        </tr>
        <tr>
          <td>Oliver</td>
          <td>Roy</td>
        ...
        <tr>
          ...
          <td>26</td>
          <td>Laborer</td>
          <td>amelia.martin@example.com</td>
        </tr>
        <tr>
          <td>Lucas</td>
          <td>Fortin</td>
          <td>51</td>
          <td>Office clerk</td>
          <td>lucas.fortin@example.com</td>
        </tr>
        <tr>
          <td>Charlotte</td>
          <td>Tremblay</td>
          ...
          <td>charlotte.tremblay@example.com</td>
        </tr>
        <tr>
          <td>Noah</td>
          <td>Gagnon</td>
        ...
        <tr>
          ...
          <td>william.gagne@example.com</td>
        </tr>
        <tr>
          <td>Olivia</td>
          <td>Smith</td>
        ...
        <tr>
          ...
          <td>37</td>
          <td>Mechanic</td>
          <td>elijah.bouchard@example.com</td>
        </tr>
        <tr>
          <td>Sophia</td>
          <td>Roy</td>
        ...
        <tr>
          ...
          <td>30</td>
          <td>Bookkeeper</td>
          <td>isabella.lee@example.com</td>
        </tr>
        <tr>
          <td>Henry</td>
          <td>Lavoie</td>
          <td>30</td>
          <td>Carpenter</td>
          <td>henry.lavoie@example.com</td>
        </tr>
        <tr>
          <td>Evelyn</td>
          <td>Johnson</td>
          ...
          <td>evelyn.johnson@example.com</td>
        </tr>
        <tr>
          <td>James</td>
          <td>C\xF4t\xE9</td>
        ...
        <tr>
          ...
          <td>68</td>
          <td>Bartender</td>
          <td>luna.macdonald@example.com</td>
        </tr>
        <tr>
          <td>Ava</td>
          <td>Wilson</td>
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>55188056</td>
          <td>1/13/2021</td>
          <td>ER EX/TX RM LEVEL IV</td>
          <td class="text-center">1</td>
          <td class="text-right">$2,268.00</td>
        </tr>
        <tr>
          <td>85025</td>
          <td>40020455</td>
          <td>1/13/2021</td>
          <td>CBC PLATELETLS AND DIFF</td>
          <td class="text-center">1</td>
        ...
        <tr>
          ...
          <td>50424688</td>
          <td>1/13/2021</td>
          <td>US ABDOMEN OR PELVIC DPLX LTO</td>
          <td class="text-center">1</td>
          <td class="text-right">$1,503.00</td>
        </tr>
        <tr>
          <td>76177</td>
          <td>50424670</td>
          ...
          <td class="text-center">1</td>
          <td class="text-right">$3,273.00</td>
        </tr>
      </tbody>
      <tfoot class="gray">
        <tr>
          ...
          <td class="text-right">$7,434.00</td>
        </tr>
      </tfoot>
    </table>
  </div>
...
`
  ...
  var TagView = createVueComponentWithCSS({
    name: "x-tag-view",
    template: template17,
    data() {
      return {
